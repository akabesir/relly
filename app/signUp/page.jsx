  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        setDocId(newDocId); // Set the new docId in the state
  ...
  return (
    ...
    >
      ...
      <div className="bg-white w-96 p-6 rounded-md shadow-md">
        ...
        <p className="text-xl font-semibold mb-4 text-gray-800">Account Created Successfully!</p>
        <p className="text-sm text-gray-600 mb-6">
          Thank you for joining Relly. Start exploring and enhancing your relationships!
        </p>
        <button
          onClick={() => router.push('signIn')}
