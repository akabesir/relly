...
const ChatComponent = () => {
  ...
  return (
    <div className="bg-white">
      <div className={`mainColor p-2 flex justify items-center`}>
        <div className="flex items-center space-x-2">
          <img
            ...
            alt="Relly Logo"
            className="w-8 h-7 bg-white rounded-full"
          />
      ...
      <div className={`p-2  mx-auto customChatWidth`}>
  {chatHistory.map((message, index) => (
    ...
    >
      ...
      {message.type === "ai" && (
        <div
          className={`bg-purple-200 textRounded p-4 max-w-md ${
      ...
      {message.type === "human" && (
        <div
          className={`bg-blue-300 textRounded p-4 max-w-md ${
            message.type === "human" ? "order-1 ml-2" : "order-2 mr-2"
          } ${isMobile ? 'mb-3' : 'none'} `}
        >
          {message.data.content}
...
<div className={` bg-white p-2 rounded-lg mx-auto inputWidth fixed bottom-10 left-0 right-0 `}>
        <div className="flex items-center space-x-2">
          <svg
            width="25"
            height="25"
          ...
          <input
            type="text"
            className={`flex-1 rounded-full p-2 border border-gray-300 `}
            placeholder="Share your thoughts..."
            value={inputMessage}
            onChange={(e) => setInputMessage(e.target.value)}
          />
          <button
            className="bg-blue-400 text-white rounded-full p-2"
